...
// Testing variables
// var url = "search.open.canada.ca/chart/si/index-fr.html?1274";
...
function consumeData(error, services_data, standards_data) {
  if (error) {
    ...
    $("h1").html(fr_page ? "Nous ne pouvons trouver cette page Web" : "We couldn't find that Web page");
    $(fr_page ? "<p>Le tableau de bord sur le rendement de l'inventaire des services est introuvable.</p>" : "<p>The service inventory performance dashboard couldn't be found.</p>")
    .insertAfter("h1");
    $(".main-content").html("")
    .attr("style", "margin-bottom: 20vh");
...
d3.queue()
  .defer(d3.csv, "https://open.canada.ca/chart/si/service_nventory.csv")
  .defer(d3.csv, "https://open.canada.ca/chart/si/service_standards.csv")
